...
async def search(query: str, sortby: str = "relevance", page: Optional[str] = None, max_pages: int = 9):
    try:
        ...
        search_url = f"search?q={query}#gsc.tab=0&gsc.q={query}&gsc.sort={sortby}&gsc.page={page or ''}"
        
        # Get the page content using Selenium
        soup, _ = selenium_open_browser(search_url, BASE_URL)
...
if __name__ == "__main__":
    queries = [('Belt and Road Initiative', 10), ('Community of Shared Future', 10), ('Community of Common Destiny', 10), ('Community of shared destiny', 10), ('Community of common destiny of mankind', 10), ('Asia Infrastructure Investment Bank', 10), ('Global Security Initiative', 10), ('Global Development Initiative', 10), ('Global Civilization Initiative', 10), ('China\'s influence', 10), ('China Soft Power', 10), ('China\'s global strategy', 10), ('China\'s global policy', 10), ('China\'s global influence', 10), ('China\'s global strategy', 10), ('China\'s global policy', 10), ('China\'s global influence', 10), ('China\'s global strategy', 10), ('China\'s global policy', 10), ('China\'s global influence', 10), ('ASEAN Perception', 10), ('China Dream', 10)]
    url_list = []
    ...
    with open("./data/url_list_kompas.json", "w") as f:
