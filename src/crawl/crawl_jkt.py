...
if __name__ == "__main__":
    ...
    queries = [('Community of shared destiny', 10), ('Community of common destiny of mankind', 10), ('Asia Infrastructure Investment Bank', 5), ('Global Security Initiative', 5), ('Global Development Initiative', 5), ('Global Civilization Initiative', 5), ('China\'s influence', 5), ('China Soft Power', 5), ('China\'s global strategy', 5), ('China\'s global policy', 5), ('China\'s global influence', 5), ('China\'s global strategy', 5), ('China\'s global policy', 5), ('China\'s global influence', 5), ('China\'s global strategy', 5), ('China\'s global policy', 5), ('China\'s global influence', 5), ('ASEAN Perception', 5), ('China Dream', 3)]
    url_list = []
    ...
    with open("url_list_jkt.json", "w") as f:
